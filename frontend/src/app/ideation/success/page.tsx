...
import { FiArrowRight, FiCheck, FiFolder, FiHome, FiLayers } from 'react-icons/fi';
    ...
    <AuthenticatedLayout>
      <div className="max-w-2xl w-full mx-auto">
        ...
        >
          {/* Success Icon */}
          <div className="mb-6">
            <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto" style={{ backgroundColor: 'var(--color-surface-hover)' }}>
          ...
          <p className="mb-8" style={{ color: 'var(--color-text-secondary)' }}>
            ...
            {ideaId && (
              <span className="block mt-2 text-sm">
                <span className="font-mono px-2 py-1 rounded" style={{ backgroundColor: 'var(--color-surface-hover)', color: 'var(--color-text)' }}>{ideaId}</span>
              </span>
            )}
          </p>

          {/* Next Steps */}
          <div className="rounded-lg p-6 mb-8 text-left" style={{ backgroundColor: 'var(--color-surface-hover)' }}>
            <h3 className="font-semibold mb-3" style={{ color: 'var(--color-text)' }}>What Is Next?</h3>
