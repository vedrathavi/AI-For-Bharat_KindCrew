...
import { generateIdeas, ContentIdea } from '@/lib/api/ideation';
import AuthenticatedLayout from '@/components/AuthenticatedLayout';
import { useAuth } from '@/hooks/useAuth';
import { FiArrowLeft, FiArrowRight, FiCompass, FiRefreshCw } from 'react-icons/fi';
...
export default function ZeroIdeaPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await generateIdeas(userInfo?.userId || 'user-123', profile);
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setProfile({ ...profile, platforms: [e.target.value] })}
                  className="w-full px-4 py-2 rounded-lg"
                  style={{
                    border: '1px solid var(--color-border)',
                    backgroundColor: 'var(--color-background)',
              ...
              {ideas.map((idea, index) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className={`text-2xl font-bold ${getScoreColor(idea.scores.overall)}`}>
                      {idea.scores.overall}
                    </span>
                  </div>
